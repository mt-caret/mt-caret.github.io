			...
			if (_elm_lang$core$Native_Utils.eq(idx, arr.length)) {
				...
				if (_p4.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'CollectionsNg.Array',
						{
							start: {line: 275, column: 9},
							end: {line: 280, column: 65}
						},
			...
			if (_elm_lang$core$Native_Utils.eq(from, to)) {
				...
				if (_p6.ctor === 'Just') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'CollectionsNg.Array',
						{
							start: {line: 319, column: 9},
							end: {line: 324, column: 65}
						},
...
var _Skinney$collections_ng$CollectionsNg_Array$slice = F3(
	function (from, to, arr) {
		...
		return (_Skinney$collections_ng$CollectionsNg_Array$isEmpty(arr) || (_elm_lang$core$Native_Utils.cmp(correctFrom, correctTo) > 0)) ? _Skinney$collections_ng$CollectionsNg_Array$empty : A4(_Skinney$collections_ng$CollectionsNg_Array$slice$, correctFrom, correctTo, _Skinney$collections_ng$CollectionsNg_Array$empty, arr);
	});
...
var _user$project$App$constant = function (value) {
	return A2(
		_elm_lang$core$Random$map,
		function (a) {
			return value;
...
var _user$project$App$switch = F2(
	function (t, array) {
		var _p0 = t;
		var i = _p0._0;
		var j = _p0._1;
		var _p1 = A2(_Skinney$collections_ng$CollectionsNg_Array$get, i, array);
		if (_p1.ctor === 'Nothing') {
			return _elm_lang$core$Native_Utils.crashCase(
				'App',
				{
			...
			var _p3 = A2(_Skinney$collections_ng$CollectionsNg_Array$get, j, array);
			if (_p3.ctor === 'Nothing') {
				return _elm_lang$core$Native_Utils.crashCase(
					'App',
					{
				...
				return A3(
					_Skinney$collections_ng$CollectionsNg_Array$set,
					i,
					_p3._0,
					A3(_Skinney$collections_ng$CollectionsNg_Array$set, j, _p1._0, array));
			}
		}
	});
var _user$project$App$random_switch = F2(
	function (range, array) {
		...
		var switch_tuple = A2(
			...
			A2(_elm_lang$core$Random$int, i, n));
		return A3(_elm_lang$core$Random$map2, _user$project$App$switch, switch_tuple, array);
	});
var _user$project$App$shuffle = function (array) {
	var zip = _elm_lang$core$List$map2(
		F2(
			function (v0, v1) {
				return {ctor: '_Tuple2', _0: v0, _1: v1};
			}));
	var n = _Skinney$collections_ng$CollectionsNg_Array$length(array);
	var ta = _Skinney$collections_ng$CollectionsNg_Array$fromList(
		A2(
			zip,
			_elm_lang$core$Native_List.range(0, n - 2),
			A2(_elm_lang$core$List$repeat, n - 1, n - 1)));
	return A3(
		_Skinney$collections_ng$CollectionsNg_Array$foldr,
		_user$project$App$random_switch,
		_user$project$App$constant(array),
		ta);
};
var _user$project$App$sample = F2(
	function (n, array) {
		return A2(
			_elm_lang$core$Random$map,
			A2(_Skinney$collections_ng$CollectionsNg_Array$slice, 0, n),
			_user$project$App$shuffle(array));
	});
var _user$project$App$sample_list = F2(
	function (n, list) {
		return A2(
			_elm_lang$core$Random$map,
			_Skinney$collections_ng$CollectionsNg_Array$toList,
			A2(
				_user$project$App$sample,
				n,
				_Skinney$collections_ng$CollectionsNg_Array$fromList(list)));
	});
var _user$project$App$Model = F3(
	function (a, b, c) {
		return {character_list: a, selection: b, pick: c};
	});
...
var _user$project$App$fetch_character_list = A3(
...
var _user$project$App$init = {
	...
	_0: A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		1),
	_1: _user$project$App$fetch_character_list
};
var _user$project$App$Select = function (a) {
		...
		switch (_p6.ctor) {
			...
			case 'Generate':
				return {
					...
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$App$Select,
						A2(_user$project$App$sample_list, model.pick, model.character_list))
				};
			case 'Select':
				return {
					ctor: '_Tuple2',
...
var _user$project$App$Generate = {ctor: 'Generate'};
var _user$project$App$ChangePick = function (a) {
	return {ctor: 'ChangePick', _0: a};
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('東方キャラ選び')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('東方に登場するキャラクターをランダムに選びます。')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$size(1),
						_elm_lang$html$Html_Attributes$value(
						_elm_lang$core$Basics$toString(model.pick)),
						_elm_lang$html$Html_Events$onInput(_user$project$App$ChangePick)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_elm_lang$html$Html$text('つ'),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$App$Generate)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('生成')
					]))
			]));
};
