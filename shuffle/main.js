...
var _mt_caret$shuffle_string$Main$fitWidth = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'width', _1: '100%'},
		_1: {ctor: '[]'}
	});
var _mt_caret$shuffle_string$Main$margin = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin', _1: '10px 0'},
		_1: {ctor: '[]'}
	});
var _mt_caret$shuffle_string$Main$flex = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _mt_caret$shuffle_string$Main$fontStyleMedium = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'font-size', _1: '4vw'},
		_1: {ctor: '[]'}
	});
var _mt_caret$shuffle_string$Main$fontStyleLarge = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'font-size', _1: '6vw'},
		_1: {ctor: '[]'}
	});
var _mt_caret$shuffle_string$Main$topLevelStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'height', _1: '100%'},
		_1: {ctor: '[]'}
	});
var _mt_caret$shuffle_string$Main$Model = F2(
	function (a, b) {
		return {string: a, shuffledString: b};
	});
var _mt_caret$shuffle_string$Main$Shuffle = {ctor: 'Shuffle'};
var _mt_caret$shuffle_string$Main$ShuffledString = function (a) {
	return {ctor: 'ShuffledString', _0: a};
};
var _mt_caret$shuffle_string$Main$shuffleString = function (str) {
	var arrayToString = function (_p0) {
		return _elm_lang$core$String$fromList(
			_elm_lang$core$Array$toList(_p0));
	};
	var stringToArray = function (_p1) {
		return _elm_lang$core$Array$fromList(
			_elm_lang$core$String$toList(_p1));
	};
	var shuffle = function (_p2) {
		return A2(
			_elm_lang$core$Random$map,
			arrayToString,
	...
	return A2(
		_elm_lang$core$Random$generate,
		_mt_caret$shuffle_string$Main$ShuffledString,
		shuffle(str));
};
var _mt_caret$shuffle_string$Main$init = function () {
	var initString = '今日も一日がんばるゾイ';
	return {
		ctor: '_Tuple2',
		_0: A2(_mt_caret$shuffle_string$Main$Model, initString, ''),
		_1: _mt_caret$shuffle_string$Main$shuffleString(initString)
	};
}();
var _mt_caret$shuffle_string$Main$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'NewString':
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _mt_caret$shuffle_string$Main$shuffleString(model.string)
				};
		}
	});
var _mt_caret$shuffle_string$Main$NewString = function (a) {
	return {ctor: 'NewString', _0: a};
};
var _mt_caret$shuffle_string$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _mt_caret$shuffle_string$Main$flex,
			_1: {
				ctor: '::',
				_0: _mt_caret$shuffle_string$Main$topLevelStyle,
				_1: {
					ctor: '::',
					_0: _mt_caret$shuffle_string$Main$fitWidth,
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _mt_caret$shuffle_string$Main$margin,
					_1: {
						ctor: '::',
						_0: _mt_caret$shuffle_string$Main$fontStyleLarge,
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(model.shuffledString),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _mt_caret$shuffle_string$Main$fontStyleMedium,
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$type_('text'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_mt_caret$shuffle_string$Main$NewString),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.string),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_mt_caret$shuffle_string$Main$Shuffle),
									_1: {ctor: '[]'}
								}
							}
						},
...
var _mt_caret$shuffle_string$Main$main = _elm_lang$html$Html$program(
	{
		view: _mt_caret$shuffle_string$Main$view,
		init: _mt_caret$shuffle_string$Main$init,
		update: _mt_caret$shuffle_string$Main$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mt_caret$shuffle_string$Main$main !== 'undefined') {
    _mt_caret$shuffle_string$Main$main(Elm['Main'], 'Main', undefined);
}
