...
{"lineNum":"    7","line":""},
{"lineNum":"    8","line":"#[ocaml_interop_export(raise_on_err)]","class":"lineNoCov","hits":"0","possible_hits":"12",},
{"lineNum":"    9","line":"fn rust_naive_date("},
{"lineNum":"   10","line":"    cr: &mut &mut OCamlRuntime,"},
{"lineNum":"   11","line":"    year: OCamlRef<OCamlInt>,","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   12","line":"    month: OCamlRef<OCamlInt>,","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   13","line":"    day: OCamlRef<OCamlInt>,","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   14","line":") -> OCaml<Option<DynBox<NaiveDate>>> {"},
{"lineNum":"   15","line":"    let year: i32 = year.to_rust(cr);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   16","line":"    let month = month.to_rust::<Coerce<_, i32, u32>>(cr).get()?;","class":"lineNoCov","hits":"0","possible_hits":"3",},
{"lineNum":"   17","line":"    let day = day.to_rust::<Coerce<_, i32, u32>>(cr).get()?;","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"   18","line":""},
{"lineNum":"   19","line":"    NaiveDate::from_ymd_opt(year, month, day)","class":"lineNoCov","hits":"0","possible_hits":"3",},
{"lineNum":"   20","line":"        .map(Abstract)"},
{"lineNum":"   21","line":"        .to_ocaml(cr)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   22","line":"}"},
{"lineNum":"   23","line":""},
{"lineNum":"   24","line":"#[ocaml_interop_export(raise_on_err)]","class":"lineNoCov","hits":"0","possible_hits":"13",},
{"lineNum":"   25","line":"fn rust_naive_date_to_naive_datetime("},
{"lineNum":"   26","line":"    cr: &mut &mut OCamlRuntime,"},
{"lineNum":"   27","line":"    date: OCamlRef<DynBox<NaiveDate>>,","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   28","line":"    hour: OCamlRef<Option<OCamlInt>>,","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   29","line":"    min: OCamlRef<Option<OCamlInt>>,","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   30","line":"    sec: OCamlRef<Option<OCamlInt>>,","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   31","line":") -> OCaml<Option<DynBox<NaiveDateTime>>> {"},
{"lineNum":"   32","line":"    let Abstract(date) = date.to_rust(cr);","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"    let hour: u32 = hour","class":"lineNoCov","hits":"0","possible_hits":"3",},
{"lineNum":"   35","line":"        .to_rust::<Coerce<_, Option<i64>, Option<u32>>>(cr)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   36","line":"        .get()?","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   37","line":"        .unwrap_or(0);"},
{"lineNum":"   38","line":"    let min: u32 = min","class":"lineNoCov","hits":"0","possible_hits":"3",},
{"lineNum":"   39","line":"        .to_rust::<Coerce<_, Option<i64>, Option<u32>>>(cr)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   40","line":"        .get()?","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   41","line":"        .unwrap_or(0);"},
{"lineNum":"   42","line":"    let sec: u32 = sec","class":"lineNoCov","hits":"0","possible_hits":"3",},
{"lineNum":"   43","line":"        .to_rust::<Coerce<_, Option<i64>, Option<u32>>>(cr)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   44","line":"        .get()?","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   45","line":"        .unwrap_or(0);"},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"    date.and_hms_opt(hour, min, sec).map(Abstract).to_ocaml(cr)","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   48","line":"}"},
{"lineNum":"   49","line":""},
...
var header = { "command" : "inline_test_runner_polars_async.exe", "date" : "2023-09-17 15:58:19", "instrumented" : 64, "covered" : 0,};
var merged_data = [];
