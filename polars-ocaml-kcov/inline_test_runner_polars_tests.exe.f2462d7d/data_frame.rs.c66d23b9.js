...
{"lineNum":"    7","line":""},
{"lineNum":"    8","line":"#[ocaml_interop_export]","class":"linePartCov","hits":"6","order":"166","possible_hits":"8",},
{"lineNum":"    9","line":"fn rust_data_frame_new("},
{"lineNum":"   10","line":"    cr: &mut &mut OCamlRuntime,"},
{"lineNum":"   11","line":"    series: OCamlRef<OCamlList<DynBox<Series>>>,","class":"lineCov","hits":"1","order":"167","possible_hits":"1",},
{"lineNum":"   12","line":") -> OCaml<Result<DynBox<DataFrame>, String>> {"},
{"lineNum":"   13","line":"    let series: Vec<Series> = unwrap_abstract_vec(series.to_rust(cr));","class":"lineCov","hits":"1","order":"168","possible_hits":"1",},
{"lineNum":"   14","line":""},
{"lineNum":"   15","line":"    DataFrame::new(series)","class":"lineCov","hits":"3","order":"173","possible_hits":"3",},
{"lineNum":"   16","line":"        .map(Abstract)"},
{"lineNum":"   17","line":"        .map_err(|err| err.to_string())","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   18","line":"        .to_ocaml(cr)","class":"lineCov","hits":"1","order":"174","possible_hits":"1",},
{"lineNum":"   19","line":"}"},
{"lineNum":"   20","line":""},
...
{"lineNum":"  200","line":""},
{"lineNum":"  201","line":"#[ocaml_interop_export]","class":"linePartCov","hits":"6","order":"205","possible_hits":"7",},
{"lineNum":"  202","line":"fn rust_data_frame_height("},
{"lineNum":"  203","line":"    cr: &mut &mut OCamlRuntime,"},
{"lineNum":"  204","line":"    data_frame: OCamlRef<DynBox<DataFrame>>,","class":"lineCov","hits":"1","order":"206","possible_hits":"1",},
{"lineNum":"  205","line":") -> OCaml<OCamlInt> {"},
{"lineNum":"  206","line":"    let Abstract(data_frame) = data_frame.to_rust(cr);","class":"lineCov","hits":"1","order":"207","possible_hits":"1",},
{"lineNum":"  207","line":"    let height = data_frame.height() as i64;","class":"lineCov","hits":"2","order":"208","possible_hits":"2",},
{"lineNum":"  208","line":"    height.to_ocaml(cr)","class":"lineCov","hits":"1","order":"209","possible_hits":"1",},
{"lineNum":"  209","line":"}","class":"linePartCov","hits":"1","order":"210","possible_hits":"2",},
{"lineNum":"  210","line":""},
{"lineNum":"  211","line":"#[ocaml_interop_export]","class":"linePartCov","hits":"7","order":"217","possible_hits":"9",},
{"lineNum":"  212","line":"fn rust_data_frame_lazy("},
{"lineNum":"  213","line":"    cr: &mut &mut OCamlRuntime,","class":"lineCov","hits":"1","order":"321","possible_hits":"1",},
{"lineNum":"  214","line":"    data_frame: OCamlRef<DynBox<DataFrame>>,","class":"lineCov","hits":"1","order":"322","possible_hits":"1",},
{"lineNum":"  215","line":") -> OCaml<DynBox<LazyFrame>> {"},
{"lineNum":"  216","line":"    dyn_box!(cr, |data_frame| data_frame.lazy())","class":"linePartCov","hits":"1","order":"323","possible_hits":"2",},
{"lineNum":"  217","line":"}"},
{"lineNum":"  218","line":""},
{"lineNum":"  219","line":"#[ocaml_interop_export]","class":"linePartCov","hits":"6","order":"216","possible_hits":"8",},
{"lineNum":"  220","line":"fn rust_data_frame_column("},
{"lineNum":"  221","line":"    cr: &mut &mut OCamlRuntime,"},
{"lineNum":"  222","line":"    data_frame: OCamlRef<DynBox<DataFrame>>,","class":"lineCov","hits":"1","order":"218","possible_hits":"1",},
{"lineNum":"  223","line":"    name: OCamlRef<String>,","class":"lineCov","hits":"1","order":"219","possible_hits":"1",},
{"lineNum":"  224","line":") -> OCaml<Result<DynBox<Series>, String>> {"},
{"lineNum":"  225","line":"    let name: String = name.to_rust(cr);","class":"lineCov","hits":"1","order":"220","possible_hits":"1",},
{"lineNum":"  226","line":""},
{"lineNum":"  227","line":"    dyn_box_result!(cr, |data_frame| data_frame.column(&name).cloned())","class":"lineCov","hits":"2","order":"221","possible_hits":"2",},
{"lineNum":"  228","line":"}","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  229","line":""},
{"lineNum":"  230","line":"#[ocaml_interop_export]","class":"linePartCov","hits":"6","order":"175","possible_hits":"8",},
{"lineNum":"  231","line":"fn rust_data_frame_columns("},
{"lineNum":"  232","line":"    cr: &mut &mut OCamlRuntime,"},
{"lineNum":"  233","line":"    data_frame: OCamlRef<DynBox<DataFrame>>,","class":"lineCov","hits":"1","order":"176","possible_hits":"1",},
{"lineNum":"  234","line":"    names: OCamlRef<OCamlList<String>>,","class":"lineCov","hits":"1","order":"177","possible_hits":"1",},
{"lineNum":"  235","line":") -> OCaml<Result<OCamlList<DynBox<Series>>, String>> {"},
{"lineNum":"  236","line":"    let Abstract(data_frame) = data_frame.to_rust(cr);","class":"lineCov","hits":"1","order":"178","possible_hits":"1",},
{"lineNum":"  237","line":"    let names: Vec<String> = names.to_rust(cr);","class":"lineCov","hits":"1","order":"179","possible_hits":"1",},
{"lineNum":"  238","line":"    data_frame","class":"lineCov","hits":"4","order":"180","possible_hits":"4",},
{"lineNum":"  239","line":"        .columns(&names)"},
{"lineNum":"  240","line":"        .map(|series| {","class":"lineCov","hits":"1","order":"181","possible_hits":"1",},
{"lineNum":"  241","line":"            series","class":"lineCov","hits":"1","order":"182","possible_hits":"1",},
{"lineNum":"  242","line":"                .into_iter()"},
{"lineNum":"  243","line":"                .map(|series| Abstract(series.clone()))","class":"lineCov","hits":"2","order":"183","possible_hits":"2",},
{"lineNum":"  244","line":"                .collect::<Vec<Abstract<_>>>()"},
{"lineNum":"  245","line":"        })","class":"linePartCov","hits":"1","order":"184","possible_hits":"2",},
{"lineNum":"  246","line":"        .map_err(|err| err.to_string())","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  247","line":"        .to_ocaml(cr)","class":"lineCov","hits":"1","order":"185","possible_hits":"1",},
{"lineNum":"  248","line":"}","class":"linePartCov","hits":"1","order":"186","possible_hits":"4",},
{"lineNum":"  249","line":""},
...
{"lineNum":"  555","line":"}"},
{"lineNum":"  556","line":""},
{"lineNum":"  557","line":"#[ocaml_interop_export]","class":"linePartCov","hits":"5","order":"211","possible_hits":"7",},
{"lineNum":"  558","line":"fn rust_data_frame_to_string_hum("},
{"lineNum":"  559","line":"    cr: &mut &mut OCamlRuntime,"},
{"lineNum":"  560","line":"    data_frame: OCamlRef<DynBox<DataFrame>>,","class":"lineCov","hits":"1","order":"212","possible_hits":"1",},
{"lineNum":"  561","line":") -> OCaml<String> {"},
{"lineNum":"  562","line":"    let Abstract(data_frame) = data_frame.to_rust(cr);","class":"lineCov","hits":"1","order":"213","possible_hits":"1",},
{"lineNum":"  563","line":"    data_frame.to_string().to_ocaml(cr)","class":"lineCov","hits":"3","order":"214","possible_hits":"3",},
{"lineNum":"  564","line":"}","class":"linePartCov","hits":"1","order":"215","possible_hits":"3",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "inline_test_runner_polars_tests.exe", "date" : "2023-09-17 15:58:55", "instrumented" : 347, "covered" : 37,};
var merged_data = [];
